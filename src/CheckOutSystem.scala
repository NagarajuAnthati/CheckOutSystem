...
object CheckOutSystem {
  ...
  def  main(args:Array[String]){
     ...
     var l= List("apple","apple","orange","apple","apple")
    ...
    if(l.length<0)
      ...
      l.foreach(x=>if (x.equalsIgnoreCase("Apple")) {
        apple_Count+=1;
        ...
        invalid_Items+=1
        println("Invalid items found.......:"+invalid_Items+"\n")
  ...
  println("Apples :"+apple_Count+"\t:"+"Oranges:"+orange_Count+"\n")
   ...
   println("Please pay :"+(apple_Count*0.60+orange_Count*0.25)+"pp")
